...
docker-compose -f infra/setup-docker/docker-compose-chain2.yml up -d
...
echo "   Stop Chain 1:    docker-compose -f infra/setup-docker/docker-compose.yml down"
echo "   Stop Chain 2:    docker-compose -f infra/setup-docker/docker-compose-chain2.yml down"
echo "   Stop Both:       ./infra/setup-docker/stop-dual-chains.sh"
echo "   Logs Chain 1:    docker-compose -f infra/setup-docker/docker-compose.yml logs -f"
echo "   Logs Chain 2:    docker-compose -f infra/setup-docker/docker-compose-chain2.yml logs -f"
