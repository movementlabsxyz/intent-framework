module mvmt_intent::fa_intent_outflow {
    ...
    public entry fun fulfill_outflow_request_intent(
        ...
        let solver_payment = primary_fungible_store::withdraw(solver, payment_metadata, 0);
    ...
    public fun create_outflow_request_intent(
        ...
        let verifier_pk = ed25519::new_unvalidated_public_key_from_bytes(verifier_public_key);
