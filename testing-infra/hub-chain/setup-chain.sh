...
docker-compose -f testing-infra/hub-chain/docker-compose-hub-chain.yml -p aptos-chain1 down 2>/dev/null || true

log ""
log "🚀 Starting Chain 1 (ports 8080/8081)..."
docker-compose -f testing-infra/hub-chain/docker-compose-hub-chain.yml -p aptos-chain1 up -d
