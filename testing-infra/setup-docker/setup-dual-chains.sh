...
docker-compose -f testing-infra/setup-docker/docker-compose.yml -p aptos-chain1 down 2>/dev/null || true
docker-compose -f testing-infra/setup-docker/docker-compose-chain2.yml -p aptos-chain2 down 2>/dev/null || true

echo ""
echo "🚀 Starting Chain 1 (ports 8080/8081)..."
docker-compose -f testing-infra/setup-docker/docker-compose.yml -p aptos-chain1 up -d

echo ""
echo "🚀 Starting Chain 2 (ports 8082/8083)..."
docker-compose -f testing-infra/setup-docker/docker-compose-chain2.yml -p aptos-chain2 up -d
...
echo "   Stop Chain 1:    docker-compose -f testing-infra/setup-docker/docker-compose.yml -p aptos-chain1 down"
echo "   Stop Chain 2:    docker-compose -f testing-infra/setup-docker/docker-compose-chain2.yml -p aptos-chain2 down"
echo "   Stop Both:       ./testing-infra/setup-docker/stop-dual-chains.sh"
echo "   Logs Chain 1:    docker-compose -f testing-infra/setup-docker/docker-compose.yml -p aptos-chain1 logs -f"
echo "   Logs Chain 2:    docker-compose -f testing-infra/setup-docker/docker-compose-chain2.yml -p aptos-chain2 logs -f"
