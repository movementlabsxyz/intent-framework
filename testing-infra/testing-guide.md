...
#   Multi-chain: python3 testing-infra/connected-chain-apt/setup_dual_chains_and_test_alice_bob.py
#   Or chains only: python3 testing-infra/connected-chain-apt/setup_dual_chains.py
