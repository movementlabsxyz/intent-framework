...
echo "======================"
echo ""
echo "📝 Module Address: $DEPLOYER_ADDRESS_FULL"
echo ""
echo "💡 Next steps:"
echo "   1. Update verifier_testnet.toml and solver_testnet.toml with:"
echo "      intent_module_address = \"$DEPLOYER_ADDRESS_FULL\""
