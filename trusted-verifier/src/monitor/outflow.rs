//! Outflow-specific monitor helpers
//!
...
use super::{EventMonitor, RequestIntentEvent, FulfillmentEvent};
        ...
        for event in raw_events {
            ...
            if event_type.contains("LimitOrderFulfillmentEvent") {
                ...
                if let Ok(data) = fulfillment_data_result {
                    ...
                    if let Err(e) = inflow::validate_and_approve_fulfillment(monitor, &fulfillment_event).await {
